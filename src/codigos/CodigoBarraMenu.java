...
public class CodigoBarraMenu extends JPanel  {

	private int initialX, initialY;
	private Window[] frame;
	
	public CodigoBarraMenu() {
		 ...
		 addMouseListener(new MouseAdapter() {
	            ...
	            public void mousePressed(MouseEvent e) {
	                ...
	                initialX = e.getX();
	                initialY = e.getY();
			Frame window = (JFrame) SwingUtilities.getWindowAncestor(CodigoBarraMenu.this);
			...
			JFrame window = (JFrame) SwingUtilities.getWindowAncestor(CodigoBarraMenu.this);
 			Point windowPosition = window.getLocationOnScreen();
		...
		setLayout(null);
		btnClose.setIcon(new ImageIcon(CodigoBarraMenu.class.getResource("/imgs/close.png")));
		...
		btnDow.setIcon(new ImageIcon(CodigoBarraMenu.class.getResource("/imgs/dow.png")));
		this.add(btnDow);
